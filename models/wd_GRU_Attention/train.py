...
flags.DEFINE_integer('max_max_epoch', 1000, 'all training epoches, default: 6')
...
# 效果不太好
# flags.DEFINE_integer('decay_step', 5000, 'decay_step, default: 15000')
# flags.DEFINE_integer('valid_step', 2000, 'valid_step, default: 10000')
# flags.DEFINE_float('last_score12', 0.0, 'if valid_score12 > last_score12, save new model. default: 0.40')

# 好
flags.DEFINE_integer('decay_step', 200, 'decay_step, default: 1000')
flags.DEFINE_integer('valid_step', 100, 'valid_step, default: 500')
...
# padding 200
# data200_train_path = '../../data/wd200_data/train/'
# data200_valid_path = '../../data/wd200_data/valid/'

data_train_path = '../../data/wd_pdQS800/train/'
data_valid_path = '../../data/wd_pdQS800/valid/'
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = network.GRU_Atten(W_embedding, settings)
        ...
        logger.info('END:Global_step={}: f1_micro={}, f1_macro={}, score12={}'.
                    format(sess.run(model.global_step), f1_micro, f1_macro, score12))
        if score12 > last_score12:  # save the better model
