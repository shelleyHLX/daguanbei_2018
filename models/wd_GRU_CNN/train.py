...
# flags.DEFINE_float('last_score12', 0.75, 'if valid_score12 > last_score12, save new model. default: 0.40')
...
embedding_path = '../../data/word2vec_400.npy'
...
data_train_path = '../../data/wd_pdQS1000/train/'
data_valid_path = '../../data/wd_pdQS1000/valid/'
...
def main(_):
    ...
    with tf.Session(config=config) as sess:
        model = network.GRU_CNN(W_embedding, settings)
