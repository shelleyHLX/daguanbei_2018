...
sys.path.append('../..')
from evaluator import cail_evaluator_least
...
data_test_path = '../../data/wd_law_pdQS200/test/'
...
def predict(sess, model, logger):
    ...
    f1_micro, f1_macro, score12 = cail_evaluator_least(predict_labels_list, marked_labels_list)
