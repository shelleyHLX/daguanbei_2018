...
from evaluator import cail_evaluator, cail_evaluator_least
...
# 效果不太好
# flags.DEFINE_integer('decay_step', 10000, 'decay_step, default: 15000')
# flags.DEFINE_integer('valid_step', 5000, 'valid_step, default: 10000')
...
# ===========  embedding: size, char, word, para
# embedding_path = '../../data/dealt_word_embedding.npy'
# embedding_path = '../../data/word_embedding_256.npy'
embedding_path = '../../data/word_embedding_256.npy'

# padding, 0 or same
# data_train_path = '../../data/wd200_data/train/'
# data_valid_path = '../../data/wd200_data/valid/'

# data_train_path = '../../data/pdQSwd200_data/train/'
# data_valid_path = '../../data/pdQSwd200_data/valid/'
